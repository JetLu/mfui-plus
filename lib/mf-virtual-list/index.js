    ...
    setup(props, { emit }) {
        ...
        const onMouseMove = (e) => {
            ...
            if (!prevPage)
                return;
            cAF(frameHandle);
            const offset = (trackRef.value.getBoundingClientRect()[bar.value.direction] -
                e[bar.value.client]) *
                -1;
    ...
    return defineComponent({
        ...
        setup(props, { emit, expose }) {
            ...
            const { onWheel } = useWheel({
                ...
                var _a, _b;
                (_b = (_a = scrollbarRef.value).onMouseUp) === null || _b === void 0 ? void 0 : _b.call(_a);
            ...
            const onScrollbarScroll = (distanceToGo, totalSteps) => {
                const offset = ((estimatedTotalSize.value - clientSize.value) /
                    totalSteps) *
                    distanceToGo;
    ...
    return defineComponent({
        ...
        setup(props, { emit, expose }) {
            ...
            const scrollTo = ({ scrollLeft, scrollTop }) => {
                ...
                const _states = $(states);
                if (scrollTop === _states.scrollTop &&
...
const es$1 = (props, gridCache, idx, offset, type) => {
    ...
    let exponent = 1;
    while (idx < total &&
        getItemFromCache$1(props, idx, gridCache, type).offset < offset) {
        idx += exponent;
        exponent *= 2;
    }
