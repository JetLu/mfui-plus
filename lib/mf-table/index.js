...
function useWatcher() {
    ...
    const _toggleAllSelection = () => {
        ...
        let childrenCount = 0;
        const rowKey = (_b = (_a = instance === null || instance === void 0 ? void 0 : instance.store) === null || _a === void 0 ? void 0 : _a.states) === null || _b === void 0 ? void 0 : _b.rowKey.value;
        data.value.forEach((row, index) => {
            const rowIndex = index + childrenCount;
            if (selectable.value) {
                if (selectable.value.call(null, row, rowIndex) &&
    ...
    const updateAllSelected = () => {
        ...
        for (let i = 0, j = (data.value || []).length; i < j; i++) {
            const keyProp = (_c = (_b = instance === null || instance === void 0 ? void 0 : instance.store) === null || _b === void 0 ? void 0 : _b.states) === null || _c === void 0 ? void 0 : _c.rowKey.value;
    ...
    const getChildrenCount = (rowKey) => {
        ...
        let count = 0;
        const children = (_a = treeData.value[rowKey]) === null || _a === void 0 ? void 0 : _a.children;
        if (children) {
