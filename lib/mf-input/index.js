...
var script = defineComponent({
    ...
    setup(props, ctx) {
        ...
        const computedTextareaStyle = computed(() => (Object.assign(Object.assign({}, _textareaCalcStyle.value), { resize: props.resize })));
        ...
        const resizeTextarea = () => {
            ...
            if (autosize) {
                ...
                _textareaCalcStyle.value = Object.assign(Object.assign({}, props.inputStyle), calcTextareaHeight(textarea.value, minRows, maxRows));
            }
            else {
                _textareaCalcStyle.value = Object.assign(Object.assign({}, props.inputStyle), { minHeight: calcTextareaHeight(textarea.value).minHeight });
            }
        };
  ...
  return (openBlock(), createBlock("div", {
    class: [
      ...
      _ctx.inputSize ? 'el-input--' + _ctx.inputSize : '',
      {
        ...
        'el-input--suffix':
          _ctx.$slots.suffix || _ctx.suffixIcon || _ctx.clearable || _ctx.showPassword,
