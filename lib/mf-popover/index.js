...
import ElPopper, { usePopper, defaultProps, renderPopper, Effect, renderArrow, renderTrigger } from '../mf-popper';
...
var script = defineComponent({
    ...
    render() {
        ...
        const _trigger = trigger
            ? renderTrigger(trigger, Object.assign({ ariaDescribedby: popperId, ref: 'triggerRef', tabindex }, events))
