...
const useSlide = (props, initData, emit) => {
    ...
    const setPosition = (percent) => {
        ...
        let buttonRefName;
        if (Math.abs(minValue.value - targetValue) <
    ...
    const setValues = () => {
        ...
        if (props.range && Array.isArray(val)) {
            if (val[1] < props.min) {
                ...
                if (valueChanged()) {
                    (_a = elFormItem.formItemMitt) === null || _a === void 0 ? void 0 : _a.emit('el.form.change', [
                        minValue.value,
                        maxValue.value,
                    ]);
...
const useLifecycle = (props, initData, resetSize) => {
    ...
    onMounted(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        sliderWrapper.value.setAttribute('aria-label', props.label
            ? props.label
