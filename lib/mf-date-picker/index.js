...
import { rangeArr, TimePickPanel, extractTimeFormat, extractDateFormat, defaultProps, DEFAULT_FORMATS_DATEPICKER, DEFAULT_FORMATS_DATE, CommonPicker } from '../mf-time-picker';
...
var script = defineComponent({
    ...
    setup(props, ctx) {
        ...
        const rows = computed(() => {
            ...
            let count = 1;
            const selectedDate = props.selectionMode === 'dates'
            ...
            for (let i = 0; i < 6; i++) {
                ...
                for (let j = 0; j < 7; j++) {
                    ...
                    cell.type = 'normal';
                    const calEndDate = props.rangeState.endDate ||
                        props.maxDate ||
                    ...
                    if (i >= 0 && i <= 1) {
                        const numberOfDaysFromPreviousMonth = startOfMonthDay + offset < 0
    ...
    setup(props, ctx) {
        ...
        const getCellStyle = cell => {
            ...
            style.disabled = props.disabledDate
                ...
                : false;
            style.current =
                coerceTruthyValueToArray(props.parsedValue).findIndex(date => date.year() === year && date.month() === month) >= 0;
        ...
        withDirectives(createVNode("div", {
          class: ["el-date-picker__header", {
            'el-date-picker__header--bordered':
              _ctx.currentView === 'year' || _ctx.currentView === 'month',
          }]
        }, [
          createVNode("button", {
            type: "button",
