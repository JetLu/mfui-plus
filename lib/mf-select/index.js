...
function useOption(props, states) {
    ...
    const isObject = computed(() => {
        return (Object.prototype.toString.call(props.value).toLowerCase() ===
            '[object object]');
    });
...
var script$1 = defineComponent({
    ...
    setup() {
        ...
        function updateMinWidth() {
            var _a;
            minWidth.value =
                ((_a = select.selectWrapper) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect().width) + 'px';
        }
        onMounted(() => {
...
const useSelect = (props, states, ctx) => {
    ...
    const optionsAllDisabled = computed(() => optionsArray.value
            ...
            ? (openBlock(), createBlock("div", {
                  ...
                  ? (openBlock(), createBlock(Transition, {
                      ...
                      default: withCtx(() => [
                        createVNode("span", {
                          style: {
                  marginLeft:
                    _ctx.prefixWidth && _ctx.selected.length ? `${_ctx.prefixWidth}px` : null,
                }
                        }, [
                ...
                (_ctx.filterable)
                  ? withDirectives((openBlock(), createBlock("input", {
                      ...
                      style: {
                marginLeft:
                  (_ctx.prefixWidth && !_ctx.selected.length) || _ctx.tagInMultiLine
                    ? `${_ctx.prefixWidth}px`
                    : null,
                flexGrow: '1',
      ...
      default: withCtx(() => [
        createVNode(_component_el_select_menu, null, {
          default: withCtx(() => [
            ...
            (
              _ctx.emptyText &&
                (!_ctx.allowCreate || _ctx.loading || (_ctx.allowCreate && _ctx.options.size === 0))
            )
