...
import { FixedSizeList, DynamicSizeList } from '../mf-virtual-list';
...
import { elFormKey, elFormItemKey } from '../mf-form';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (_ctx.item.isTitle)
    ? (openBlock(), createBlock("div", {
      ...
      }, toDisplayString(_ctx.item.label), 5 /* TEXT, STYLE */))
    : (openBlock(), createBlock("div", {
        key: 1,
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("li", {
    ...
    renderSlot(_ctx.$slots, "default", {
      ...
      createVNode("span", null, toDisplayString(_ctx.item.label), 1 /* TEXT */)
    ])
  ], 46 /* CLASS, STYLE, PROPS, HYDRATE_EVENTS */, ["aria-selected"]))
}
...
var script$2 = defineComponent({
    ...
    setup(props) {
        ...
        const isEqual = (selected, target) => {
            if (!isObject$1(target)) {
                ...
                return (getValueByPath(selected, valueKey) ===
    ...
    render(_ctx, _cache) {
        var _a;
        const { $slots, data, listProps, select, isSized, width, isItemDisabled, isItemHovering, isItemSelected, } = _ctx;
        ...
        if (data.length === 0) {
            ...
            }, (_a = $slots.empty) === null || _a === void 0 ? void 0 : _a.call($slots));
        }
        const ListItem = withCtx((scoped) => {
            ...
            return h(script$1, Object.assign(Object.assign({}, scoped), { selected, disabled: item.disabled || itemDisabled, hovering: isItemHovering(index), item,
                onSelect }), {
        ...
        const List = h(Comp, Object.assign({ ref: 'listRef', className: 'el-select-dropdown__list', data,
            height,
            width, total: data.length, onKeydown: [
                _cache[1] ||
                    (_cache[1] = withKeys(withModifiers(() => onKeyboardNavigate('forward'), ['stop', 'prevent']), ['down'])),
                _cache[2] ||
                    (_cache[2] = withKeys(withModifiers(() => onKeyboardNavigate('backward'), ['stop', 'prevent']), ['up'])),
                _cache[3] ||
                    (_cache[3] = withKeys(withModifiers(onKeyboardSelect, ['stop', 'prevent']), ['enter'])),
                _cache[4] ||
                    (_cache[4] = withKeys(withModifiers(() => (select.expanded = false), ['stop', 'prevent']), ['esc'])),
                _cache[5] ||
...
const useSelect = (props, emit) => {
    ...
    const iconClass = computed(() => props.remote && props.filterable
        ? ''
        : expanded.value
            ? 'arrow-up is-reverse'
            : 'arrow-up');
        ...
        return flattenOptions(props.options
            ...
            if (isArray(v.options)) {
                ...
                if (filtered.length > 0) {
                    return Object.assign(Object.assign({}, v), { options: filtered });
                }
            }
            else {
                if (isValidOption(v)) {
    ...
    const popperSize = computed(() => {
        var _a, _b, _c;
        return ((_c = (_b = (_a = selectRef.value) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect) === null || _b === void 0 ? void 0 : _b.call(_a)) === null || _c === void 0 ? void 0 : _c.width) || 200;
    });
    const inputWrapperStyle = computed(() => {
        return {
            width: `${states.calculatedWidth === 0
                ? MINIMUM_INPUT_WIDTH
                : Math.ceil(states.calculatedWidth) + MINIMUM_INPUT_WIDTH}px`,
        };
    });
    ...
    const popperRef = computed(() => { var _a; return (_a = popper.value) === null || _a === void 0 ? void 0 : _a.popperRef; });
    ...
    const focusAndUpdatePopup = () => {
        var _a, _b, _c, _d;
        (_b = (_a = inputRef.value).focus) === null || _b === void 0 ? void 0 : _b.call(_a);
        (_d = (_c = popper.value).update) === null || _d === void 0 ? void 0 : _d.call(_c);
    };
    const toggleMenu = () => {
        var _a, _b;
        ...
        if (!selectDisabled.value) {
            ...
            (_b = (_a = inputRef.value) === null || _a === void 0 ? void 0 : _a.focus) === null || _b === void 0 ? void 0 : _b.call(_a);
        }
    };
    ...
    const handleBlur = () => {
        ...
        nextTick(() => {
            var _a, _b;
            (_b = (_a = inputRef.value) === null || _a === void 0 ? void 0 : _a.blur) === null || _b === void 0 ? void 0 : _b.call(_a);
    ...
    watch(expanded, val => {
        ...
        if (val) {
            (_b = (_a = popper.value).update) === null || _b === void 0 ? void 0 : _b.call(_a);
        }
        else {
...
var script$3 = defineComponent({
    ...
    setup(props, { emit }) {
        ...
        provide(selectKey, {
            props: reactive(Object.assign(Object.assign({}, toRefs(props)), { height: API.popupHeight })),
        ...
        createVNode("div", {
          ...
          (_ctx.multiple)
                ...
                (_ctx.collapseTags && _ctx.modelValue.length > 0)
                  ? (openBlock(), createBlock("div", _hoisted_3, [
                      createVNode(_component_el_tag, {
                        closable: 
                    !_ctx.selectDisabled && !_ctx.states.cachedOptions[0].disable
                  ,
                        ...
                        default: withCtx(() => [
                          ...
                          }, toDisplayString(_ctx.states.cachedOptions[0].label), 5 /* TEXT, STYLE */)
                        ]),
                        _: 1 /* STABLE */
                      }, 8 /* PROPS */, ["closable", "size"]),
                      (_ctx.modelValue.length > 1)
                        ? (openBlock(), createBlock(_component_el_tag, {
                            ...
                            default: withCtx(() => [
                              createVNode("span", _hoisted_4, "+ " + toDisplayString(_ctx.modelValue.length - 1), 1 /* TEXT */)
                            ]),
                            _: 1 /* STABLE */
                          }, 8 /* PROPS */, ["size"]))
                        : createCommentVNode("v-if", true)
                  ...
                  : (openBlock(true), createBlock(Fragment, { key: 1 }, renderList(_ctx.states.cachedOptions, (selected, idx) => {
                      return (openBlock(), createBlock("div", {
                        ...
                        createVNode(_component_el_tag, {
                          ...
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(_ctx.getLabel(selected)), 1 /* TEXT */)
                          ]),
                          _: 2 /* DYNAMIC */
                        }, 1032 /* PROPS, DYNAMIC_SLOTS */, ["closable", "size", "onClose"])
                      ]))
                    }), 128 /* KEYED_FRAGMENT */)),
                createVNode("div", {
                  ...
                  withDirectives(createVNode("input", {
                    ...
                    type: "text",
                    name: _ctx.name,
                    unselectable: _ctx.expanded ? 'on' : undefined,
                  ...
                  }, null, 40 /* PROPS, HYDRATE_EVENTS */, ["id", "autocomplete", "aria-expanded", "aria-labelledby", "disabled", "readonly", "name", "unselectable"]), [
            ...
            : (openBlock(), createBlock(Fragment, { key: 2 }, [
                createVNode("div", _hoisted_5, [
                  ...
                  }, null, 40 /* PROPS, HYDRATE_EVENTS */, ["id", "aria-labelledby", "aria-expanded", "autocomplete", "disabled", "name", "readonly", "unselectable"]), [
                    [_directive_model_text, _ctx.states.displayInputValue]
                  ])
                ]),
                (_ctx.filterable)
          ...
          (_ctx.shouldShowPlaceholder)
            ? (openBlock(), createBlock("span", {
              ...
              }, toDisplayString(_ctx.currentPlaceholder), 3 /* TEXT, CLASS */))
            : createCommentVNode("v-if", true),
        ...
        createVNode(_component_el_select_menu, {
          ...
          empty: withCtx(() => [
            renderSlot(_ctx.$slots, "empty", {}, () => [
              createVNode("p", _hoisted_7, toDisplayString(_ctx.emptyText), 1 /* TEXT */)
            ])
          ]),
          _: 1 /* STABLE */
        }, 8 /* PROPS */, ["data", "width", "hovering-index"])
      ]),
      _: 1 /* STABLE */
    }, 8 /* PROPS */, ["visible", "append-to-body", "popper-class", "popper-options", "onBeforeEnter"])
