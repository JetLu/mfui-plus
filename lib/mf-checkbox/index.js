...
const useModel = (props) => {
    ...
    const model = computed({
        get() {
            var _a;
            return isGroup.value ? store.value : (_a = props.modelValue) !== null && _a !== void 0 ? _a : selfModel.value;
        },
        set(val) {
            var _a;
            if (isGroup.value && Array.isArray(val)) {
                isLimitExceeded.value = false;
                if (checkboxGroup.min !== undefined &&
                    val.length < checkboxGroup.min.value) {
                    isLimitExceeded.value = true;
                }
                if (checkboxGroup.max !== undefined &&
...
const useCheckboxStatus = (props, { model }) => {
    ...
    const size = computed(() => {
        var _a;
        return ((_a = checkboxGroup === null || checkboxGroup === void 0 ? void 0 : checkboxGroup.checkboxGroupSize) === null || _a === void 0 ? void 0 : _a.value) ||
