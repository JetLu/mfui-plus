...
import { Overlay } from '../mf-overlay';
...
var script = defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const icon = computed(() => state.iconClass ||
        ...
        watch(() => visible.value, val => {
            if (val) {
                if (props.boxType === 'alert' || props.boxType === 'confirm') {
                    nextTick().then(() => {
                        var _a, _b, _c;
                        (_c = (_b = (_a = confirmRef.value) === null || _a === void 0 ? void 0 : _a.$el) === null || _b === void 0 ? void 0 : _b.focus) === null || _c === void 0 ? void 0 : _c.call(_b);
                    });
                }
          ...
          { 'el-message-box--center': _ctx.center },
            ...
            (_ctx.title !== null && _ctx.title !== undefined)
              ...
              _ctx.handleAction(_ctx.distinguishCancelAndClose ? 'close' : 'cancel')
                        ...
                        onKeydown: _cache[2] || (_cache[2] = withKeys(withModifiers($event => (
              _ctx.handleAction(_ctx.distinguishCancelAndClose ? 'close' : 'cancel')
            ), ["prevent"]), ["enter"]))
                      }, [
                        _hoisted_3
