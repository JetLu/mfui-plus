...
function buildModifier(props, externalModifiers = []) {
    ...
    const modifiers = [
        ...
        },
        {
            ...
            options: {
                padding: 5,
                fallbackPlacements: fallbackPlacements !== null && fallbackPlacements !== void 0 ? fallbackPlacements : [],
            },
        },
        {
            name: 'computeStyles',
...
var script = defineComponent({
    ...
    render() {
        ...
        const triggerProps = Object.assign({ 'aria-describedby': popperId, class: kls, style, ref: 'triggerRef' }, this.events);
