...
import ElCascaderPanel, { CommonProps } from '../mf-cascader-panel';
    ...
    setup(props, { emit }) {
        ...
        const updateStyle = () => {
            ...
            if (tagWrapperEl) {
                ...
                const height = presentTags.value.length > 0
        ...
        onMounted(() => {
            ...
            inputInitialHeight =
                (inputEl === null || inputEl === void 0 ? void 0 : inputEl.offsetHeight) ||
