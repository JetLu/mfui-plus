...
import type { CascaderValue, CascaderNode, Tag } from '../../mf-cascader-panel';
declare const _default: import("vue").DefineComponent<{
    ...
    options: {
        type: PropType<import("../../mf-cascader-panel").CascaderOption[]>;
        default: () => import("../../mf-cascader-panel").CascaderOption[];
    };
    props: {
        type: PropType<import("../../mf-cascader-panel").CascaderProps>;
        default: () => import("../../mf-cascader-panel").CascaderProps;
    };
}, {
    popperOptions: {
        modifiers: {
