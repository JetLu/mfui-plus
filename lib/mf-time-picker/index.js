...
var script$1 = defineComponent({
    ...
    setup(props, ctx) {
        ...
        const handleScroll = type => {
            ...
            const value = Math.min(Math.round((listRefsMap[type].value.$el.querySelector('.el-scrollbar__wrap')
                .scrollTop -
                (scrollBarHeight(type) * 0.5 - 10) / typeItemHeight(type) +
                3) /
                typeItemHeight(type)), type === 'hours' ? 23 : 59);
            modifyDateField(type, value);
        };
          ...
          return (openBlock(), createBlock("div", {
            ...
            createVNode("ul", _hoisted_3, [
              ...
              disabled: _ctx.listMap[item].value[time],
                ...
                }, toDisplayString(time === undefined
                ? ''
                : ('0' + (_ctx.amPmMode ? time % 12 || 12 : time)).slice(-2) +
                  _ctx.getAmPmFlag(time)), 3 /* TEXT, CLASS */))
              }), 128 /* KEYED_FRAGMENT */))
            ])
...
var TimePicker = defineComponent({
    ...
    setup(props, ctx) {
        ...
        return () => {
            var _a;
            const format = (_a = props.format) !== null && _a !== void 0 ? _a : DEFAULT_FORMATS_TIME;
            return h(script, Object.assign(Object.assign({}, props), { format,
                type, ref: commonPicker, 'onUpdate:modelValue': value => ctx.emit('update:modelValue', value) }), {
