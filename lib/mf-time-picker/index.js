...
const parser = function(date, format) {
  const day = util.isEmpty(format) ? dayjs__default['default'](date) : dayjs__default['default'](date, format);
  return day.isValid() ? day : void 0;
};
const formatter = function(date, format) {
  return util.isEmpty(format) ? date : dayjs__default['default'](date).format(format);
};
    ...
    trigger: vue.withCtx(() => [
      !_ctx.isRangeInput ? vue.withDirectives((vue.openBlock(), vue.createBlock(_component_el_input, {
        ...
        vue.renderSlot(_ctx.$slots, "range-separator", {}, () => [
          vue.createVNode("span", _hoisted_1, vue.toDisplayString(_ctx.rangeSeparator), 1)
        ]),
        vue.createVNode("input", {
          autocomplete: "off",
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock("div", {
    ...
    !_ctx.arrowControl ? (vue.openBlock(true), vue.createBlock(vue.Fragment, { key: 0 }, vue.renderList(_ctx.spinnerItems, (item) => {
    ...
    _ctx.arrowControl ? (vue.openBlock(true), vue.createBlock(vue.Fragment, { key: 1 }, vue.renderList(_ctx.spinnerItems, (item) => {
      return vue.openBlock(), vue.createBlock("div", {
        key: item,
        class: "el-time-spinner__wrapper is-arrow",
        onMouseenter: ($event) => _ctx.emitSelectRange(item)
      }, [
        vue.withDirectives(vue.createVNode("i", _hoisted_1$1, null, 512), [
          [_directive_repeat_click, _ctx.onDecreaseClick]
        ]),
        vue.withDirectives(vue.createVNode("i", _hoisted_2, null, 512), [
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock(vue.Transition, { name: _ctx.transitionName }, {
    default: vue.withCtx(() => [
      _ctx.actualVisible || _ctx.visible ? (vue.openBlock(), vue.createBlock("div", _hoisted_1$2, [
        vue.createVNode("div", {
...
var script$3 = vue.defineComponent({
  ...
  setup(props, ctx) {
    ...
    const getDefaultValue = () => {
      ...
      return [dayjs__default['default'](defaultValue), dayjs__default['default'](defaultValue).add(60, "m")];
    };
    ctx.emit("set-picker-option", ["formatToString", formatToString]);
    ctx.emit("set-picker-option", ["parseUserInput", parseUserInput]);
    ctx.emit("set-picker-option", ["isValidValue", isValidValue]);
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_time_spinner = vue.resolveComponent("time-spinner");
  return _ctx.actualVisible ? (vue.openBlock(), vue.createBlock("div", _hoisted_1$3, [
    vue.createVNode("div", _hoisted_2$2, [
      vue.createVNode("div", _hoisted_3$1, [
        vue.createVNode("div", _hoisted_4, vue.toDisplayString(_ctx.t("el.datepicker.startTime")), 1),
        vue.createVNode("div", {
      ...
      vue.createVNode("div", _hoisted_5, [
        vue.createVNode("div", _hoisted_6, vue.toDisplayString(_ctx.t("el.datepicker.endTime")), 1),
        vue.createVNode("div", {
          class: [{ "has-seconds": _ctx.showSeconds, "is-arrow": _ctx.arrowControl }, "el-time-range-picker__body el-time-panel__content"]
        }, [
          vue.createVNode(_component_time_spinner, {
    ...
    vue.createVNode("div", _hoisted_7, [
      ...
      vue.createVNode("button", {
        ...
        onClick: _cache[2] || (_cache[2] = ($event) => _ctx.handleConfirm())
      }, vue.toDisplayString(_ctx.t("el.datepicker.confirm")), 9, ["disabled"])
    ])
  ])) : vue.createCommentVNode("v-if", true);
}
