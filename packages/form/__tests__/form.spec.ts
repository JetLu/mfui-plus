...
import installStyle from '@missfresh/test-utils/style-plugin'
import Input from '@missfresh/input/src/index.vue'
import Checkbox from '@missfresh/checkbox/src/checkbox.vue'
import CheckboxGroup from '@missfresh/checkbox/src/checkbox-group.vue'
