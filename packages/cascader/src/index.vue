...
import { ClickOutside as Clickoutside } from '@missfresh/directives'
import { t } from '@missfresh/locale'
import { isPromise } from '@vue/shared'
import debounce from 'lodash/debounce'
import { EVENT_CODE } from '@missfresh/utils/aria'
import { UPDATE_MODEL_EVENT, CHANGE_EVENT } from '@missfresh/utils/constants'
import isServer from '@missfresh/utils/isServer'
import { useGlobalConfig } from '@missfresh/utils/util'
import {
  addResizeListener,
  removeResizeListener,
} from '@missfresh/utils/resize-event'
import { isValidComponentSize } from '@missfresh/utils/validators'
import { elFormKey, elFormItemKey } from '@missfresh/form'
import { CommonProps } from '@missfresh/cascader-panel'

import type { ComputedRef, PropType } from 'vue'
import type { ElFormContext, ElFormItemContext } from '@missfresh/form'
import type {
  CascaderValue,
  CascaderNode,
  Tag,
} from '@missfresh/cascader-panel'
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const realSize: ComputedRef<string> = computed(
